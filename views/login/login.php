        ...
        <div class = "col-auto">
            <div class="card border-primary mb-3" style="max-width: 20rem;">
                ...
                <form action="<?php echo "index.php?c=".seg::codificar("login")."&m=".seg::codificar("validar") ?>" method="post">
                    ...
                    <!-- Submit button -->
                    <button type="submit" class="bbtn btn-outline-dark btn-block mb-4">Iniciar Sesion</button>

                    <!-- Register buttons -->
                    <div class="text-center">
                        <p> <a href="https://github.com/">Registrate</a></p>
                        <p>O </p>
                        <p>Iniciar Sesion Con:</p>
                       

                        <button type="button" class="btn btn-primary btn-floating mx-1">
                        <i class="bi bi-google" style="vertical-align: -.350em;"></i>
                        </button>
